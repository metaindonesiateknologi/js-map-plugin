...
export function search_address_by_name(text, appid, token, proxy) {
    ...
    const ptr3 = passStringToWasm0(proxy, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len3 = WASM_VECTOR_LEN;
    const ret = wasm.search_address_by_name(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function search_address_by_coord(lat_str, lon_str, appid, token_str, proxy) {
    ...
    const len3 = WASM_VECTOR_LEN;
    const ptr4 = passStringToWasm0(proxy, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.search_address_by_coord(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function map_route(start, start_lat, start_lon, dest, dest_lat, dest_lon, appid, token) {
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_gethost_bf2ee9b3352ca77c = function(arg0) {
        const ret = get_host();
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('mit_map_plugin_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
