...
export const search_address_by_name: (a: number, b: number, c: number, d: number, e: number, f: number) => any;
...
export const translate_route_fn: (a: number, b: number) => [number, number];
...
export const closure140_externref_shim: (a: number, b: number, c: any, d: any) => void;
